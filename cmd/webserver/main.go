...
func run() error {
	if len(os.Args) != 4 { return errors.New("Usage: " + os.Args[0] + " <sitefile> <certfile> <keyfile>") }
	...
	server, err := webserver.Create(os.Args[1])
	if err != nil { return err }
	server.Start(errChan, os.Args[2], os.Args[3])
